...
lookup_provider_functions = {
    ...
    "archive": _lookup_provider_official_legacy(provider="archive", thing_prefix="archive_"),
    ...
    "cloudflare": _lookup_provider_official_legacy(provider="cloudflare", ghorg="cloudflare", ghbranch="master"),
    "cloudinit": _lookup_provider_official_legacy(provider="cloudinit", thing_prefix="cloudinit_"),
    "consul": _lookup_provider_official_legacy(provider="consul", ghbranch="master"),
    "datadog": _lookup_provider_tfplugindocs(provider="datadog", ghorg="DataDog", ghbranch="master"),
    "dns": _lookup_provider_official_legacy(provider="dns", thing_prefix="dns_"),
    ...
    "local": _lookup_provider_official_legacy(provider="local", file_extension=".html.md"),
    "netbox": _lookup_provider_official_legacy(provider="netbox", ghorg="e-breuninger", ghbranch="master", file_extension=".md"),
    ...
    "time": _lookup_provider_official_legacy(provider="time"),
