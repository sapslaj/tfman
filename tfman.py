...
lookup_provider_functions = {
    ...
    "lacework": _lookup_provider_tfplugindocs(provider="lacework", ghorg="lacework"),
    "launchdarkly": _lookup_provider_tfplugindocs(provider="launchdarkly", ghorg="launchdarkly"),
